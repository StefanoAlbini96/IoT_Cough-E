...
float *_discrete_diff(float *sig, int16_t *timestamps, int16_t len){
    ...
    float *res = (float*)k_malloc((res_len) * sizeof(float));
...
float _max_vdist(float *sig, int16_t first, int16_t last, int16_t *idx){
    ...
    float *intrp = (float*)k_malloc(len * sizeof(float));
    _interp(len, first, sig[first], last, sig[last], intrp);
    
    // To store the distances 
    float *dist = (float*)k_malloc(len * sizeof(float));
...
int16_t *polygonal_approx(float *sig, int16_t len, float eps, int16_t *res_len){
    ...
    int16_t *res = (int16_t*)k_malloc(len * sizeof(int16_t));
    ...
    seg_idxs_t *stack = (seg_idxs_t*)k_malloc(len * sizeof(seg_idxs_t));
...
int16_t azc_computation(float *sig, int16_t len, float epsilon){
    ...
    float *approx_sig = (float*)k_malloc(approx_len * sizeof(float));
    int16_t *timestamps = (int16_t*)k_malloc(approx_len * sizeof(int16_t));
